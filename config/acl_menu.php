...
return [
    ...
    "list" => [
        [
            "name" => "Dashboard",
            "route" => "dashboard",
            "link" => '/tvts_2016-2017/public/admin/users/dashboard',
            "permissions" => []
        ],
        [
            /*
             ...
             */
            "link" => '/tvts_2016-2017/public/admin/users/list',
            /*
        ...
        [
            "name" => "Groups",
            "route" => "groups",
            "link" => '/tvts_2016-2017/public/admin/groups/list',
            "permissions" => ["_superadmin", "_group-editor"]
        ],
        [
            "name" => "Permission",
            "route" => "permission",
            "link" => '/tvts_2016-2017/public/admin/permissions/list',
        ...
        [
            ...
            "name" => "sample",
            "route" => "selfprofile",
            "link" => '/tvts_2016-2017/public/admin/sample',
            "permissions" => []
        ],
        [
            /*
            ...
            "name" => "post",
            "route" => "post",
            "link" => '/tvts_2016-2017/public/admin/post',
            "permissions" => []
        ],
         [
            /*
            ...
            "name" => "contact",
            "route" => "contact",
            "link" => '/tvts_2016-2017/public/admin/contact',
            "permissions" => []
        ],
    ]
];
