...
<html lang="en">
    <head>
        ...
        {!! HTML::style('ckeditor/samples/css/samples.css') !!}
        {!! HTML::style('ckeditor/samples/toolbarconfigurator/lib/codemirror/neo.css') !!}
        @yield('head_css')
        {{-- End head css --}}
    ...
    <body>
        ...
        {!! HTML::script('js/unisharp.js') !!}
        {!! HTML::script('vendor/laravel-filemanager/js/lfm.js') !!}
        {!! HTML::script('tinymce/js/tinymce/tinymce.min.js') !!}
        {!! HTML::script('tinymce/js/tinymce/jquery.tinymce.min.js') !!}
        //ckeditor
        {!! HTML::script('ckeditor/ckeditor.js') !!}
        <!--        {!! HTML::script('ckeditor/js/sample.js') !!}-->
